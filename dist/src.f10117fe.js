...
function () {
  ...
  Model.prototype.checkForId = function () {
  ...
  Model.prototype.fetch = function () {
    ...
    var id = this.checkForId();
    this.sync.fetch(id).then(function (res) {
      var data = res.data;

      _this.set(data); // using this.set instead of this.attributes.set because we want to be sure we trigger the change
...
function () {
  ...
  Eventing.createEventHandler = function () {
    return new Eventing();
  };
...
var ApiSync_1 = __importDefault(require("./ApiSync"));
...
function (_super) {
  ...
  User.buildUser = function (attr) {
    return new User(new Attributes_1.default(attr), new Eventing_1.default(), new ApiSync_1.default('http://localhost:3000/users'));
  };
...
},{"./Model":"src/models/Model.ts","./Collection":"src/models/Collection.ts","./Attributes":"src/models/Attributes.ts","./Eventing":"src/models/Eventing.ts","./ApiSync":"src/models/ApiSync.ts"}],"src/views/CollectionView.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function CollectionsView(parent, collection) {
    this.parent = parent;
...
exports.default = CollectionsView;
...
var userCollection = new Collection_1.default('http://localhost:3000/users', function (json) {
  return User_1.default.buildUser(json);
});
...
userCollection.on('change', function () {
  ...
  if (root) {
    new UserList_1.default(root, userCollection).render();
  }
});
